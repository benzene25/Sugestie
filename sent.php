  <table width="700">
    ...
    <tr align="center">
                ...
                <td><?php echo $msg_date;?> hrs</td>
                <td>
                    <a href="my_messages.php?sent&msg_id=<?php echo $msg_id;?>">Reply</a>
                </td>
...
<?php
    ...
    if(isset($_GET['msg_id'])){
        ...
        echo "<center><br/><hr>
        <h2>$msg_subject</h2>
        <p><font color='red'>My Message:</font> $msg_topic</p>
        <p><font color='red'>Their Reply:</font> $reply_content</p>
